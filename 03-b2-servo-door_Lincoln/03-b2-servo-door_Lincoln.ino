// Main trap has dual PIR sensor in the middle. When the PIR detects movement
// in the given time window the trap will trigger, hopefully causing the pest
// into the holding cage. Cage PIR will trigger, release vertical door close.
// Pest caught in rear cage and Zeppelin. No reset.
